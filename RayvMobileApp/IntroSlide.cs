...
namespace RayvMobileApp
{
	public class IntroSlide : StackLayout
	{
		...
		void Setup (string topPic,
		            string heading,
		            string buttonLabel,
		            EventHandler buttonAction,
		            bool fullWidthButton,
		            bool showKeepShowingButton)
		{
			...
			if (showKeepShowingButton) {
				Label ShowLbl = new Label {
					Text = "Show this every time"
				};
				Switch ShowSw = new Switch {
					IsToggled = true
				};
		...
		{
			Setup (topPic, heading, buttonLabel, buttonAction, fullWidthButton, showKeepShowingButton);
		...
		)
		{
			...
			grid.Children.Add (Pic1, 1, 4, 2, 3);
			Label Text1 = new Label { Text = text1, FontSize = settings.FontSizeLabelSmall, TextColor = settings.ColorDarkGray };
			grid.Children.Add (Text1, 3, 4, 3, 4);
			Label Heading2 = new Label { Text = heading2, FontSize = settings.FontSizeLabelLarge, };
			grid.Children.Add (Heading2, 1, 4, 4, 5);
			Image Pic2 = new Image{ Source = widePic2, Aspect = Aspect.AspectFit, HeightRequest = 25 };
			grid.Children.Add (Pic2, 1, 2, 5, 6);
			Label Text2 = new Label { Text = text2, FontSize = settings.FontSizeLabelSmall, TextColor = settings.ColorDarkGray };
			grid.Children.Add (Text2, 3, 4, 5, 6);
		}
	}
}
